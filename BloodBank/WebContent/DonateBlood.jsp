	...
	<div id="wrapper">
		...
		<%
	        try{
	   		 ...
	   		 String sql="SELECT * FROM test.recipient where test.recipient.recipientid not  in (select recipientid from test.donates);";
		     ...
		     ResultSet r=p.executeQuery();
			     ...
			     while(r.next()){
			    	 ...
			    	 out.println("<td>"+r.getString(2)+"</td>");			    	 
		 	    	 ...
		 	    	 out.println("<td><a href='/BloodBank/donateblood?recipientid="+r.getString(1)+"&quantity="+r.getString(8)+"'><i class='fa fa-check' aria-hidden='true'style='color:green;'></i></a></td> </tr>");
			     } 
