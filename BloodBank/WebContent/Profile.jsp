	...
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				<div class="container">
					<a href="#menu-toggle" style="background-color:black;color:white;" class="btn btn-default" id="menu-toggle">
					Menu</a><br>
	        ...
	        try{
	   		 ...
	   		 String sql="SELECT * FROM test.users where username='"+username+"';";
			      ...
			      %>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<textarea name='phoneNo' id='phoneNo' class="form-control"><%=r.getString(5)%> </textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="email" class="col-sm-3 control-label">Email</label>
							<div class="col-sm-6">
								<textarea name='email' id='email' class="form-control"><%=r.getString(4)%> </textarea>
							</div>
						</div>
						<%
